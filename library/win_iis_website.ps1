...
Try {
  ...
  If($site) {
    ...
    if ($anonymousAuthentication) {
        $currentAnonymousAuthentication = (Get-WebConfigurationProperty -filter /system.webServer/security/authentication/anonymousAuthentication -name enabled -PSPath IIS:\ -location $name).Value
    ...
    if ($windowsAuthentication) {
        ...
        $currentWindowsAuthentication = (Get-WebConfigurationProperty -filter /system.webServer/security/authentication/windowsAuthentication -name enabled -PSPath IIS:\ -location $name).Value
    ...
    if ($basicAuthentication) {
        $currentBasicAuthentication = (Get-WebConfigurationProperty -filter /system.webServer/security/authentication/basicAuthentication -name enabled -PSPath IIS:\ -location $name).Value
    ...
    if ($formsAuthentication) {
        $currentFormsAuthentication = (Get-WebConfiguration system.web/authentication "IIS:Sites\$name")
